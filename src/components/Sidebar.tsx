      ...
      <aside className={`fixed top-0 bottom-0 left-0 z-50 w-64 border-r border-zinc-800 bg-zinc-900 flex flex-col h-screen overflow-hidden transition-transform duration-300 ease-in-out shadow-2xl text-zinc-100 ${
          ...
          {showAddForm && (
            <form onSubmit={handleCreate} className="px-2 space-y-2">
              ...
              <div className="flex gap-2">
                <button 
                  type="submit" 
                  className="flex-1 bg-zinc-100 text-zinc-950 text-xs font-bold py-1.5 px-3 rounded border-2 border-black shadow-[3px_3px_0px_0px_rgba(255,255,255,0.2)] transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none cursor-pointer"
                >
                  Create
                </button>
                <button 
                  ...
                  className="flex-1 bg-zinc-800 text-zinc-300 text-xs font-semibold py-1.5 px-3 rounded border-2 border-black shadow-[3px_3px_0px_0px_rgba(255,255,255,0.2)] transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none cursor-pointer"
                >
                  Cancel
                </button>
              </div>
        ...
        <div className="p-6 border-t border-zinc-800 space-y-3 bg-zinc-900">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-zinc-100 text-zinc-950 font-bold py-2 px-4 rounded-lg border-2 border-black shadow-[3px_3px_0px_0px_rgba(255,255,255,0.2)] transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none cursor-pointer disabled:opacity-50 text-xs"
          >
            {pdfGenerating ? (
              <>
          ...
          <div className="flex gap-2 border-t border-zinc-800 pt-3 text-[11px] text-zinc-500">
            <label className="flex-1 flex items-center justify-center gap-1 bg-zinc-800 border-2 border-black py-1.5 rounded shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] transition-all hover:translate-x-[0.5px] hover:translate-y-[0.5px] hover:shadow-[1.5px_1.5px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none cursor-pointer text-zinc-300">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 bg-zinc-800 border-2 border-black py-1.5 rounded shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] transition-all hover:translate-x-[0.5px] hover:translate-y-[0.5px] hover:shadow-[1.5px_1.5px_0px_0px_rgba(255,255,255,0.2)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none cursor-pointer text-zinc-300"
            >
